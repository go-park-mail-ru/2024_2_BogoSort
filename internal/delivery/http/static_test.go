...
// 	staticID := uuid.New()
// 	mockStaticUC.EXPECT().GetStatic(staticID).Return("http://example.com/staticfile", nil)
...
// 	staticID := uuid.New()
// 	mockStaticUC.EXPECT().GetStatic(staticID).Return("", ErrStaticFileNotFound)
...
// 	staticID := uuid.New()
// 	mockStaticUC.EXPECT().GetStatic(staticID).Return("", errors.New("internal error"))
